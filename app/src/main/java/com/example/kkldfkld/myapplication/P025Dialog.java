...
public class P025Dialog extends Activity implements View.OnClickListener{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
    ...
    @Override
    public void onClick(View v) {
        Dialog dialog=new Dialog(this);  //,android.R.layout.select_dialog_item); istersen diger parametreleri arastirabilirsin
        dialog.setTitle("Hello from Dialog");
        TextView textView=new TextView(this);
        textView.setText("Yeni bir arac kullanimi basarili");
        dialog.setContentView(textView);
