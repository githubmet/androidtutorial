...
public class P009ReturnArrayAdapterCustomRow extends ArrayAdapter<String>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View geriGelenView= layoutInflater.inflate(R.layout.p009returnarrayadaptercustomrow, parent);

        TextView textViewP009=(TextView)geriGelenView.findViewById(R.id.textViewP009);
        ImageView imageViewP009= (ImageView)geriGelenView.findViewById(R.id.imageViewP009);
